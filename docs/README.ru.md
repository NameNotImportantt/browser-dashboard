...
| **Хранение**             | Оффлайн-персистентность                         | Все основные данные — в IndexedDB через Dexie. Без аккаунта и облачной синхронизации.                                                                                                                     |
...
Укажите URL вида `file:///` на скачанный файл. Или откройте файл при  помощи браузера.
...
См. [руководство разработчика](./DEVELOPERS.ru.md).
